...
| **Presentation (15%) — artifacts** | **Prepared and publicly linked** | Strong README, canonical modern architecture, judge guide, evidence matrix, honest eval method, Devpost copy, story, public build article, final screenshots, and a public 168-second narrated video. | The video has hash-locked local narration, manual English captions, and independent media/audio QA; final signed-out playback and Devpost submission remain entrant-controlled gates. |
